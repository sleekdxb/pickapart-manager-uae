...
import { addPartCategory, type AddPartCategoryData } from "../../../../../services/partsManagmentService";

interface NewCategoryDialogProps {
  open: boolean;
  onClose: () => void;
  onSuccess?: (category: AddPartCategoryData) => void;
}
...
export default function NewCategoryDialog({ open, onClose, onSuccess }: NewCategoryDialogProps) {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await addPartCategory(name, imageFile);
